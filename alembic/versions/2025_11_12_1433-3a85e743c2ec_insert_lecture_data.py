...
def upgrade() -> None:
    ...
    op.execute("""
        INSERT INTO lecture (semester, lecture_time, lecture_room, capacity, course_code, professor_id)
        VALUES
        ('2025-2', '월 3-4', '경영관 303호', 50, 'BUS101', 'P4001'),
        ('2025-2', '화 1-2', '경영관 304호', 50, 'BUS102', 'P4002'),
        ('2025-2', '수 5-6', '경영관 303호', 40, 'BUS201', 'P4001'),
        ('2025-2', '화 1-3', '조형관 105호', 30, 'DES101', 'P5001'),
        ('2025-2', '목 1-2', '조형관 202호', 30, 'DES102', 'P5001')
    """)
